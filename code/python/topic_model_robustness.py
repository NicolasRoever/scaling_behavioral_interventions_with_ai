...
FIG_PATH = PACKAGE_ROOT / "results/figures/fig_topic_robustness_elbow.pdf"
...
def get_documents():
    docs, doc_idx, data = load_topic_model_documents(PACKAGE_ROOT)
...
def load_original_topic_keywords():
    ...
    ref = pd.read_csv(PACKAGE_ROOT / "data/processed/main_social_media/bertopic_labeled.csv",
