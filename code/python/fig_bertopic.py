...
# Resolve paths from this script so the figure is reproducible across users.
PACKAGE_ROOT = Path(__file__).resolve().parents[2]
OUTPUT_PATH = PACKAGE_ROOT / "results/figures/fig_bertopic.pdf"
STABILITY_SUMMARY_PATH = (
    Path(__file__).parent / "output" / "topic_seed_stability_summary.csv"
)
