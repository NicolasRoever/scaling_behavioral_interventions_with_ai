...
# Public package root. The private chats_raw.csv input is intentionally absent.
...
scripts = pd.read_csv(PACKAGE_ROOT / "data/private/chats_raw.csv", usecols=["session_id", "type", "content", "question_name", "order"])
...
# Export
df.to_csv(PACKAGE_ROOT / "data/processed/main_social_media/bertopic_labeled.csv", index=False)

# test = pd.read_csv(PACKAGE_ROOT / "data/processed/main_social_media/bertopic_labeled.csv")
